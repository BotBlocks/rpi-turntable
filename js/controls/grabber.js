THREE.grabber = function( object, camera, cursor, scalex, scaley, domElement ) {
	...
	function mousedown ( event ) {
		...
		dragStart.copy( _this.getMouseVector( _this.domElement, event.clientX, event.clientY, _this.zOffset ) ).applyEuler(_this.pivot.rotation, _this.pivot.eulerOrder).add(_this.pivotPosition);
